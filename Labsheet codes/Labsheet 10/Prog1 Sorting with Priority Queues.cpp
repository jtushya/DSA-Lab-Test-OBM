/*
Problem:
This program demonstrates sorting using Min and Max Priority Queues. It sorts a list of integers in ascending and descending order and also sorts a list of 2D points by their y-coordinates.

Intuition and Logic:
1. Priority Queues are used to efficiently sort elements based on custom comparators.
2. A Min-Priority Queue is implemented using a comparator that prioritizes smaller elements.
3. A Max-Priority Queue is implemented using a comparator that prioritizes larger elements.
4. For sorting 2D points, a custom comparator is used to prioritize points based on their y-coordinates.
5. The program demonstrates the use of STL priority_queue with custom comparators to achieve the desired sorting order.
*/
